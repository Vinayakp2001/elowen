    ...
    <div className="pt-16 min-h-screen bg-[#FDFAF5] flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        <div className="mb-10">
          ...
          <h1 className="font-serif text-[2rem] text-[#2C2C2C]">Sign In</h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6" noValidate>
          ...
          {error && (
            <p className="font-sans text-[0.75rem] text-red-500">{error}</p>
          )}
        ...
        <div className="mt-6 flex items-center gap-4">
          ...
          <span className="font-sans text-[0.65rem] tracking-[0.1em] uppercase text-[#8C7B6B]">
            or
          </span>
          <div className="flex-1 h-px bg-[#E8D9C0]" />
        </div>
        ...
        <a
          ...
          className="mt-6 w-full flex items-center justify-center gap-3 border border-[#E8D9C0] py-3 font-sans text-[0.7rem] tracking-[0.1em] uppercase text-[#2C2C2C] hover:border-[#B8975A] hover:text-[#B8975A] transition-colors duration-200"
        >
